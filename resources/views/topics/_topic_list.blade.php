            ...
            <li class="d-flex">
                <div class="">
                    <a href="{{ route('users.show', [$topic->user_id]) }}">
                        <img class="media-object img-thumbnail me-3" style="width: 52px; height: 52px;"
                             src="{{ $topic->user->avatar }}" title="{{ $topic->user->name }}" alt="">
                    </a>
                </div>
                ...
                <div class="flex-grow-1 ms-2">
                    ...
                    <small class="media-body meta text-secondary">
                        ...
                        <span class="timeago"
                              title="Last active at：{{ $topic->updated_at }}">{{ $topic->updated_at->diffForHumans() }}</span>
                    </small>
